...
class TFModel(NNModel, metaclass=TfModelMeta):
    ...
    def get_train_op(self,
        ...
        Args:
            ...
            **kwargs: parameters passed to tf.compat.v1.train.Optimizer object
        ...
        with opt_scope:
            ...
            if optimizer is None:
                optimizer = tf.compat.v1.train.compat.v1.AdamOptimizer
...
class LRScheduledTFModel(TFModel, LRScheduledModel):
    ...
    def __init__(self,
        ...
        ## if not issubclass(self._optimizer, tf.keras.optimizers.Optimizer):
